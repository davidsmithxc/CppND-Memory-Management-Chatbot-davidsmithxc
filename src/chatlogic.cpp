...
ChatLogic::ChatLogic()
{
    ...
    // create instance of chatbot -> Per task 5, move to LoadAnswerGraphFromFile
...
ChatLogic::~ChatLogic()
{
    ...
    // with task 5, this is no longer needed.
    // delete _chatBot;

    // delete all nodes -> don't need to do this with a smart pointer
    // for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    // {
    //     delete *it;
    // }

    // delete all edges -> don't need to delete them anymore with smart pointer
...
{
    std::cout << "loading answer graph" << std::endl;
    ...
    // identify root node
    std::cout << "identifying root node" << std::endl;
